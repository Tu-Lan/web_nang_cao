<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phone_lap.aspx.cs" Inherits="SneakerShop.WebForm4" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PHONE & LAP</title>
...
<body>
     <div class="header">
		...
		<div class="header_bot" id="header-bot">
			...
			<ul>
				...
				<li><a id="selected" href="phone_lap.aspx">PHONE & LAP</a></li>
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>HOME</strong></a> / <a href="phone_lap.aspx"><strong>PHONE & LAP</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="phone_lap1" runat="server">
                    <ItemTemplate>
