                    ...
                    <tr>
                        ...
                        <td>
                            <div class="quantity-container">
								<%--<button class="quantity-button" onclick="decreaseQuantity(<%#Eval("Id")%>)">-</button>
								<span id="quantity_<%#Eval("Quantity")%>"><%#Eval("Quantity")%></span>
								<button class="quantity-button" onclick="increaseQuantity(<%#Eval("Id")%>)">+</button>--%>

								<a class="quantity-button" href="Trusoluong.aspx?id=<%#Eval("Id")%>">-</a>
								<span id="quantity_<%#Eval("Quantity")%>"><%#Eval("Quantity")%></span>
								<a class="quantity-button" href="Themsoluong.aspx?id=<%#Eval("Id")%>">+</a>
							</div>
                        </td>
    ...
    <div class="cart_price">
        <div class="cart--right">
			...
			<div class="cart__delivery-price">
                 <p>Delivery:</p>
                 <p runat="server" id="delivery_price">0 <span class="cart__product-price-unit">$</span></p>
             </div>
             <hr>
